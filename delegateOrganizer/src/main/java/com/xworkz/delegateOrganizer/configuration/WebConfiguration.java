package com.xworkz.delegateOrganizer.configuration;
...
@Configuration
@ComponentScan("com.xworkz.delegateOrganizer")
public class WebConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean localContainerEntityManagerFactoryBean(){
        ...
        factoryBean.setPackagesToScan("com.xworkz.delegateOrganizer.entity");
    ...
    public DataSource dataSource(){
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/delegate_db");
