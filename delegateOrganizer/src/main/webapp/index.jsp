      ...
      <div class="d-flex align-items-center gap-3">
        <div class="dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end">
            <li><a class="dropdown-item" href="delegate.jsp"><i class="bi bi-person me-2 opacity-50"></i>Delegate</a></li>
            <li><a class="dropdown-item" href="conference.jsp"><i class="bi bi-building me-2 opacity-50"></i>Organizer</a></li>
          </ul>
        </div>
...
<section class="video-section">
  <div class="container">
    ...
    <div class="row g-4 mt-5">
      ...
      <div class="col-lg-3 col-md-6 reveal">
        <div class="video-wrap"><iframe src="https://www.youtube.com/embed/3DcFnwFAwP

        w?autoplay=1&mute=1&loop=1&playlist=3DcFnwFAwPw&controls=0" allow="autoplay; encrypted-media" loading="lazy" allowfullscreen style="height:180px;"></iframe></div>
      </div>
      <div class="col-lg-3 col-md-6 reveal">
